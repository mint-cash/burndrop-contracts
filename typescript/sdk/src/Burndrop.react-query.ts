...
export function useBurndropSimulateBurnQuery<TData = SimulateBurnResponse>({
  ...
  return useQuery<SimulateBurnResponse, Error, TData>(
    ['burndropSimulateBurn', client.contractAddress, JSON.stringify(args)],
    () =>
      client.simulateBurn({
        amount: args.amount,
      }),
...
export interface BurndropCurrentPriceQuery<TData>
  extends BurndropReactQuery<PriceResponse, TData> {}
...
export interface BurndropUserInfoQuery<TData>
  extends BurndropReactQuery<UserInfoResponse, TData> {
  args: {
    address: string;
  };
}
export function useBurndropUserInfoQuery<TData = UserInfoResponse>({
  ...
  return useQuery<UserInfoResponse, Error, TData>(
    ['burndropUserInfo', client.contractAddress, JSON.stringify(args)],
    () =>
      client.userInfo({
...
export interface BurndropConfigQuery<TData>
  extends BurndropReactQuery<Config, TData> {}
export function useBurndropConfigQuery<TData = Config>({
  client,
  options,
}: BurndropConfigQuery<TData>) {
  return useQuery<Config, Error, TData>(
    ['burndropConfig', client.contractAddress],
    () => client.config(),
    options,
  );
}
