...
export const queryClient = selectorFamily<BurndropQueryClient, QueryClientParams>({
...
export const userInfoSelector = selectorFamily<UserInfoResponse, QueryClientParams & {
...
export const currentPriceSelector = selectorFamily<PriceResponse, QueryClientParams & {
...
export const simulateBurnSelector = selectorFamily<SimulateBurnResponse, QueryClientParams & {
