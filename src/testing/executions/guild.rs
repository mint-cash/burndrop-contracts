...
use crate::testing::utils::assert_event_strict;
...
fn success_create_guild() {
    ...
    let expected_event = Event::new("wasm")
        ...
        .add_attribute("_contract_address", burn_contract.addr().as_str());
    assert_event_strict(create_guild_res.unwrap(), &expected_event);
...
fn success_migrate_guild() {
    ...
    let expected_event = Event::new("wasm")
        ...
        .add_attribute("_contract_address", burn_contract.addr().as_str());
    assert_event_strict(migrate_guild_res.unwrap(), &expected_event);
